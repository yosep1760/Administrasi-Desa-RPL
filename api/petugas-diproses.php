...
$query = "SELECT surat.*, pengguna.nama AS nama_warga 
          ...
          WHERE surat.status IN ('Diproses', 'Persetujuan Kades', 'Selesai')
...
<head>
  ...
  <title>Surat Diproses - NamaWeb</title>
    ...
    <div class="konten-dashboard">
      ...
      <main class="area-konten">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:1.5rem;">
          <h1 style="font-family:var(--font-judul);font-size:1.5rem;font-weight:700;">Riwayat Surat Diproses</h1>
        </div>
        ...
        <div class="kartu-tabel">
          <table class="tabel-data">
            ...
            <tbody>
              ...
              <?php else: ?>
                  <tr>
                    <td colspan="5" style="text-align:center; padding: 20px;">Belum ada surat yang diteruskan atau selesai diproses.</td>
                  </tr>
              <?php endif; ?>
            </tbody>
          </table>
