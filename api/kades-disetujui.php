...
<head>
  ...
  <title>Surat Disetujui - NamaWeb</title>
    ...
    <aside id="sidebar" class="sidebar">
      ...
      <nav class="sidebar-nav">
        ...
        <div class="sidebar-sub">
          ...
          <a href="kades-disetujui.php" class="sidebar-link aktif"><span class="sidebar-link-ikon">✅</span>Surat Disetujui</a>
        ...
        <div class="kartu-tabel">
          <table class="tabel-data">
            ...
            <tbody>
              ...
              <?php else: ?>
                  <tr>
                    <td colspan="6" style="text-align:center; padding: 20px;">Belum ada riwayat surat yang disetujui.</td>
                  </tr>
              <?php endif; ?>
            </tbody>
          </table>
